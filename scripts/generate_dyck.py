...
from platonic_init.formal_language import infer_dataset_stem
from platonic_init.formal_language import generate_formal_language_lines
...
def main() -> None:
    ...
    if args.output is None:
        out_path = Path("data") / f"{infer_dataset_stem('dyck', args.n_samples, max_depth=args.max_depth)}.txt"
    else:
